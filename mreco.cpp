...
int main(int argc, char **argv) {
  ...
  cout << "Recover completed, it recovered " << tconn.count(collection) + dups
       << " rows in total in " << end - start << " seconds" << endl;
  cout << "Please check collection " << collection << " and " << collDup
       << " for details " << endl;
  cout << "If the ids is duplicated, the later records will be stored in "
       << collDup << " with its fieldName '_id' changed to " << nid << endl;
  cout << "The real value of _id for these duplicated rows is generated by c++ "
